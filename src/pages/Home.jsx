    ...
    🚧 Serving Calgary with Premium Garage Builds & Renovations since 2000 • Free Quotes Available • Trusted by 1000+ Clients • Quality You Can Count On 🚧
      ...
      <section className="relative min-h-screen flex items-center justify-center perspective-1000">
        <Slider {...carouselSettings} className="w-full h-screen">
          {[
            { img: 'garage-hero.jpg', title: 'Build Your Dream Garage with KARTAR Construction', subtitle: 'Crafting exceptional garages in Calgary with precision and innovation since 2000.' },
            { img: 'garage-service1.jpg', title: 'Transform Your Space with Expert Renovations', subtitle: 'Modernize your garage with KARTAR’s innovative solutions.' },
            { img: 'garage-service2.jpg', title: 'Commercial Garages Built to Last', subtitle: 'Durable, high-capacity solutions for businesses in Calgary.' },
          ].map((slide, index) => (
